...
```shell
git clone https://github.com/dannyvassallo/iprevailradio.git
cd iprevailradio
```

From the "iprevailradio" directory, install the gems by running the following:
```shell
bundle install
```

To fire up the server while in the "iprevailradio" directory use this command:
```shell
middleman s
```
...
pwd
```
It should turn up "iprevailradio"
